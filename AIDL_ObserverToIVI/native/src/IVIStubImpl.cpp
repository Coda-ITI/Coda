...
void IVIStubImpl::requestTheme(const std::shared_ptr<CommonAPI::ClientId> _client, 
                              requestThemeReply_t _reply) {
    (void)_client; // Unused parameter
    _reply(currentTheme_);
}

void IVIStubImpl::changeTheme(const std::shared_ptr<CommonAPI::ClientId> _client, 
                             IVI::Theme _theme, 
                             changeThemeReply_t _reply) {
    (void)_client; // Unused parameter
