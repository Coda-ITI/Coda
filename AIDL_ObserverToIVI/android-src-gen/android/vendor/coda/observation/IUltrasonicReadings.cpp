...
static binder_status_t _aidl_android_vendor_coda_observation_IUltrasonicReadings_onTransact(AIBinder* _aidl_binder, transaction_code_t _aidl_code, const AParcel* _aidl_in, AParcel* _aidl_out) {
  (void)_aidl_in;
  (void)_aidl_out;
...
static const char* _g_aidl_android_vendor_coda_observation_IUltrasonicReadings_clazz_code_to_function[] = { "onUltrasonicChanged",};
static AIBinder_Class* _g_aidl_android_vendor_coda_observation_IUltrasonicReadings_clazz = ::ndk::ICInterface::defineClass(IUltrasonicReadings::descriptor, _aidl_android_vendor_coda_observation_IUltrasonicReadings_onTransact, _g_aidl_android_vendor_coda_observation_IUltrasonicReadings_clazz_code_to_function, 1);
...
::ndk::SpAIBinder BnUltrasonicReadings::createBinder() {
  AIBinder* binder = AIBinder_new(_g_aidl_android_vendor_coda_observation_IUltrasonicReadings_clazz, static_cast<void*>(this));
  #ifdef BINDER_STABILITY_SUPPORT
...
const char* IUltrasonicReadings::descriptor = "android.vendor.coda.observation.IUltrasonicReadings";
...
std::shared_ptr<IUltrasonicReadings> IUltrasonicReadings::fromBinder(const ::ndk::SpAIBinder& binder) {
  if (!AIBinder_associateClass(binder.get(), _g_aidl_android_vendor_coda_observation_IUltrasonicReadings_clazz)) {
