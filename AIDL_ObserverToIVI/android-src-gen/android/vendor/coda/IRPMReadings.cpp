...
namespace vendor {
namespace coda {
static binder_status_t _aidl_android_vendor_coda_IRPMReadings_onTransact(AIBinder* _aidl_binder, transaction_code_t _aidl_code, const AParcel* _aidl_in, AParcel* _aidl_out) {
  (void)_aidl_in;
  (void)_aidl_out;
...
static const char* _g_aidl_android_vendor_coda_IRPMReadings_clazz_code_to_function[] = { "onRpmChanged",};
static AIBinder_Class* _g_aidl_android_vendor_coda_IRPMReadings_clazz = ::ndk::ICInterface::defineClass(IRPMReadings::descriptor, _aidl_android_vendor_coda_IRPMReadings_onTransact, _g_aidl_android_vendor_coda_IRPMReadings_clazz_code_to_function, 1);
...
::ndk::SpAIBinder BnRPMReadings::createBinder() {
  AIBinder* binder = AIBinder_new(_g_aidl_android_vendor_coda_IRPMReadings_clazz, static_cast<void*>(this));
  #ifdef BINDER_STABILITY_SUPPORT
...
const char* IRPMReadings::descriptor = "android.vendor.coda.IRPMReadings";
IRPMReadings::IRPMReadings() {}
IRPMReadings::~IRPMReadings() {}


std::shared_ptr<IRPMReadings> IRPMReadings::fromBinder(const ::ndk::SpAIBinder& binder) {
  if (!AIBinder_associateClass(binder.get(), _g_aidl_android_vendor_coda_IRPMReadings_clazz)) {
