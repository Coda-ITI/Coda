...
namespace vendor {
namespace coda {
class BpUltrasonicReadings : public ::ndk::BpCInterface<IUltrasonicReadings> {
public:
  explicit BpUltrasonicReadings(const ::ndk::SpAIBinder& binder);
  virtual ~BpUltrasonicReadings();
